...
<div class="container" style="margin-top:60px;">
	...
	<%
		...
		String expheader = request.getParameter("expheader");
		...
		if(expdesc!=null)
		{
			if(payopt.equals("1"))
			{
				if(chqno!=null && chqdate!=null && chqamt!=null && chqdop!=null)
				{
					...
					int res = d.addExpenditure(expdesc,"cheque",s,chqamt,chqdop,expheader);
					
					if(res == 1)
					{
						out.println("<div class=\"alert alert-success\">"+
								  "<strong>Success!</strong>Expenditure Added Successfully</div>");
					}
					else
					{
						out.println("<div class=\"alert alert-danger\">"+
								  "<strong>Error!</strong>Expenditure Not Added Successfully</div>");
					}
				}
				else
				{
			...
			else if(payopt.equals("2"))
			{
				if(neftno!=null && neftdate!=null && neftamt!=null)
				{
					...
					int res = d.addExpenditure(expdesc,"neft",s,neftamt,neftdate,expheader);
			...
			else if(payopt.equals("3"))
			{
				if(impsno!=null && impsdate!=null && impsamt!=null)
				{
					...
					int res = d.addExpenditure(expdesc,"imps",s,impsamt,impsdate,expheader);
			...
			{
				System.out.println(cashamt+" "+cashdop);
				if(cashamt!=null && cashdop!=null)
				{
					int res = d.addExpenditure(expdesc,"cash","",cashamt,cashdop,expheader);
	...
	%>
		...
		<form action="http://localhost:8182/society_latierra/addexpenditure.jsp" method="post">
		<br>
		<select class="form-control" name="expheader">
			<%
      	...
      	<br>
		<textarea class="form-control" rows="5" placeholder="Expenditure description..." name="expdesc" id="comment"></textarea>
		<br>
			<div class="row">
				<div class="col-md-4">
		...
		<div class="container" id="container1" style="display:block;"><br>
			...
			<div class="row">
				...
				<button style="margin-top:10px;" type="submit" class="btn btn-success">Pay Your Expenditure</button>
