...
<div class="container" style="margin-top:60px;">
	...
	<%
		...
		if(id!=null)
		{
			...
			if(expdesc!=null)
			{
				if(payopt.equals("1"))
				{
					if(chqno!=null && chqdate!=null && chqamt!=null && chqdop!=null)
					{
						...
						int res = d.updateIncomeSpecific(id,chqamt,"cheque",s,expdesc,chqdop);
						
						if(res == 1)
						{
							out.println("<div class=\"alert alert-success\">"+
									  "<strong>Success!</strong>Income Updated Successfully</div>");
						}
						else
						{
							out.println("<div class=\"alert alert-danger\">"+
									  "<strong>Error!</strong>Income Not Updated Successfully</div>");
						}
					}
					else
					{
				...
				else if(payopt.equals("2"))
				{
					if(neftno!=null && neftdate!=null && neftamt!=null)
					{
						...
						int res = d.updateIncomeSpecific(id,neftamt,"neft",s,expdesc,neftdate);
				...
				else if(payopt.equals("3"))
				{
					if(impsno!=null && impsdate!=null && impsamt!=null)
					{
						...
						int res = d.updateIncomeSpecific(id,impsamt,"imps",s,expdesc,impsdate);
				...
				else if(payopt.equals("4"))
				{
					if(cashamt!=null && cashdop!=null)
					{
						...
						int res = d.updateIncomeSpecific(id,cashamt,"cash","",expdesc,cashdop);
			...
			income i = d.getIncomeById(id);
			
			if(i!=null)
			{
				out.println("<form action=\"http://localhost:8182/society_latierra/editincomeinfo.jsp?id="+i.getId()+"\" method=\"post\">");
